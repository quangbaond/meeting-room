...
window.addEventListener('load', () => {
    ...
    document.getElementById('create-room').addEventListener('click', (e) => {
        ...
        if (roomName && yourName) {
            ...
            document.querySelector('#room-created').innerHTML = `Phòng của bạn đã được tạo. Click <a href='${roomLink}'>vào đây</a> để vào room.
                Chia sẻ đường link này cho bạn bè của bạn.`;
